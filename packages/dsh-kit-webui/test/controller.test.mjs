...
import { ThemeStoreController } from '../src/client/controller.ts'
import { BUILTIN_THEMES, saveStored } from '../src/client/themes.ts'
...
function setup(hostThemes = []) {
  ...
  globalThis.fetch = async (url, opts) => {
    if (String(url).endsWith('/dsh-kit-webui/themes') && (opts === undefined || opts.method === undefined)) {
